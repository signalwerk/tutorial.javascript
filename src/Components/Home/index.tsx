...
const Home = () => (
  <div className="home">
    ...
    <p>
      ...
      Blindtext, ihr Name war Lorem Ipsum, hinaus zu gehen in die weite
      ...
      schob sich sein Initial in den Gürtel und machte sich auf den Weg. Als es
      ...
      setzte es seinen Weg fort. Unterwegs traf es eine Copy. Die Copy warnte
      das Blindtextchen, da, wo sie herkäme wäre sie zigmal umgeschrieben worden
      ...
      auflauerten, es mit Longe und Parole betrunken machten und es dann in ihre
      Agentur schleppten, wo sie es für ihre Projekte wieder und wieder
      mißbrauchten. Und wenn es nicht umgeschrieben wurde, dann benutzen Sie es
      immernoch.


      <Link to="/course/js/basic/intro/overview">Start</Link>
